...
if app_mode == "Home":
    ...
    st.image("Designer_Climate Prediction.png", caption="Climate and Weather Trends", use_container_width=True)
...
# EDA Section
    ...
    st.image("eda_visualisations.png", caption="Exploratory Data Analysis: Climate Trends in Tanzania")
    st.image("Seasonal_Decomposition.png", caption="Seasonal Decomposition")
    st.image("feature_importance_rf.png", caption="Feature Importance")
